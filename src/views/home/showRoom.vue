      ...
      <div class="show">
        <div class="left">
          ...
          <div class="viewall" :class="{ newviewall:!show}">
            ...
            <div class="viewright" @click="testshow5()" v-show="!show5" style="cursor:pointer"><i
        ...
        <div class="right">
          <div class="texttitle">
            <div class="titleleft">
              <span>SORT BY</span>
              <el-select @change="sortChange(sortBy)" v-model="sortBy" placeholder="Year: Low to High">
                <el-option
                  ...
                  <span class="optionspan"
                        style="font-size: 16px;font-family: DINCondensed-Bold;color: #000;">{{ item.label }}</span>
                </el-option>
              </el-select>
            </div>
...
/deep/ .el-loading-spinner i {
  ...
  width: 80px;
  height: 80px;
  background: url("../../assets/images/onlineshowroom/loading.gif") center center no-repeat;
